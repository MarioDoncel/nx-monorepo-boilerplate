...
Create new module/library/infra

```
npx nx g @nx/js:lib shared/<name>
npx nx g @nx/js:lib backend/infra/<name>
npx nx g @nx/js:lib backend/modules/<name>
```

Create new app

```
npx nx g @nx/node:app backend/apis/<name>
```
